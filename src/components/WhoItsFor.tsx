      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-7">
          {targetSegments.map((seg, idx) => {
            const Icon = seg.icon;
            const cardBackgrounds: Record<number, { img: string; alt: string }> = {
              0: {
                img: '/manufacturing-bg.jpg',
                alt: 'Scrap claw crane lifting metal scrap at yard',
              },
              1: {
                img: '/traders-bg.jpg',
                alt: 'Scrap yard inventory warehouse with scrap wiring and auto parts',
              },
              2: {
                img: '/processors-bg.jpg',
                alt: 'Shredded and granulated aluminum scrap material in hand',
              },
            };

            const bgConfig = cardBackgrounds[idx];
